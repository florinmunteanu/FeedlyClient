...
//@UIApplicationMain
class __AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func setupContext() {
        ...
        //splitViewController.displayMode = UISplitViewControllerDisplayMode.AllVisible
        
        let masterNavigationController = splitViewController.viewControllers[0] as UINavigationController
        let controller = masterNavigationController.topViewController as CategoriesViewController
        controller.managedObjectContext = self.managedObjectContext
        
        let childNavigationController = splitViewController.childViewControllers[1] as CategorySubscriptionsViewController
        //let detailController = childNavigationController.topViewController as CategorySubscriptionsViewController
        childNavigationController.managedObjectContext = self.managedObjectContext
    }

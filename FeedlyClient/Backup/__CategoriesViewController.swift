...
class __CategoriesViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let subscriptionsViewController = UIStoryboard(name: "UniversalStoryboard", bundle: nil).instantiateViewControllerWithIdentifier("Subscriptions") as CategorySubscriptionsViewController
        
        var category = self.fetchedResultsController.objectAtIndexPath(indexPath) as Category
        subscriptionsViewController.managedObjectContext = self.managedObjectContext
        subscriptionsViewController.categoryId = category.id
        
        showDetailViewController(subscriptionsViewController, sender: self)
    }
